// RaBbLE Emissive Fragment Shader - JS Wrapper
// Emissive material with per-instance glow intensity
// Used for body particles, aura, eye whites, and glowing elements

export const FRAGMENT_SHADER_EMISSIVE = `
  ...
  void main() {
    ...
    color = mix(color, entropyColor, u_entropy * 0.15);
    
    // Apply per-instance emissive glow
    // The particle burns with its own inner light
    color += color * v_instanceEmissive * 2.0;
